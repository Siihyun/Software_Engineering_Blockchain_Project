...
#define Dhex_dump(a, b, c, d) //hex_dump(a, b, c, d)
#define PDEBUG
#define PWDEBUG(f_, ...)//printf("(DEBUG) "); printf((f_), ##__VA_ARGS__)
#define DEBUG(f_, ...) //printf("(DEBUG) "); printf((f_), ##__VA_ARGS__)
#define START(f_, ...) //printf("(START FUCN) "); printf((f_), ##__VA_ARGS__)
#define END(f_, ...)   //printf("(END FUNC)   "); printf((f_), ##__VA_ARGS__)
#define DEBUG2(f_, ...) //printf("(DEBUG)         "); printf((f_), ##__VA_ARGS__)
#define START2(f_, ...) //printf("(START FUCN)    "); printf((f_), ##__VA_ARGS__)
//#define hex_dump(a1, a2, a3, a4)
